...
export interface ManualClaimAlertPlan {
  status: CdkStatus;
...
export const getManualClaimAlertPlan = (window: CdkWindow, now: Date): ManualClaimAlertPlan => {
...
export const getClaimableManualMessage = (): string => CLAIMABLE_TEXT;
